...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => getenv('DRUPALDB_DATABASE'),
      'username' => getenv('DRUPALDB_USER'),
      'password' => getenv('DRUPALDB_PASSWORD'),
      'host' => getenv('DRUPALDB_HOST'),
      'port' => getenv('DRUPALDB_PORT'),
      'driver' => 'mysql',
      'prefix' => '',
    ),
  ),
 ...
 *
 */
$drupal_hash_salt = '7NpytxoVrrMhQuaQJtDrMv5klRg6I38yAIHX41FPoSE';
 ...
 */
$conf['site_name'] = 'Docker Drupal Test';
